...
def process_data():
    ...
    bucket = "airflow-projects-tanul"
    emp_data_path = f"gs://{bucket}/airflow-projects-1/data/employee.csv"
    dept_data_path = f"gs://{bucket}/airflow-projects-1/data/department.csv"
    output_path = f"gs://{bucket}/airflow-projects-1/output"
